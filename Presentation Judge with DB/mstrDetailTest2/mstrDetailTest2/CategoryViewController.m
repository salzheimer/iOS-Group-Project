...
-(SectionDBAccess *)sectionList
{
    if(!_sectionList)
    {
        _sectionList =[[SectionDBAccess alloc]init];
    }
    return _sectionList;
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return [self.sectionList getSectionCountByPresentationID:presentationID];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [self.sectionList getPresentation_SectionNameForIndex:indexPath.row presentationID: presentationID];
